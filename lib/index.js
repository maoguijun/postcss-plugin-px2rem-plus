...
exports.default = _postcss2.default.plugin("postcss-plugin-px2rem-plus", function (options) {
  ...
  return function (css) {
    css.walkDecls(function (decl, i) {
      var _decl = decl;
      // 1st check include
      if (opts.include && css.source.input.file && css.source.input.file.match(opts.include) === null) {
        return;
      }
      // 2nd check exclude
